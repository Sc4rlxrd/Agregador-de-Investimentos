package com.scarlxrd.agregadorinvestimentos.service;
...
public class UserServiceTest {
    ...
    class updateUserById {
        ...
        void shouldUpdateUserByIdWhenUserExistsAndUsernameAndPasswordIsFilled() {
            ...
            // Act
            userService.updateUserById(updateUserDto, user.getUserId().toString());
        ...
        void shouldNotUpdateUserWhenUserNotExists() {
            ...
            // Act
            userService.updateUserById(updateUserDto, userId.toString());
